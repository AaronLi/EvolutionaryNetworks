...
class GameTile:
    ...
    def colour(self):
        ...
        colour = (int(self.temperature * 128), min(255,int(self.current_food * 255)+32), int(self.growth_rate * 255))
    ...
    def update(self):
        ...
        self.current_food = min((self.temperature * self.growth_rate)*self.growth_reduction+self.current_food, 1)
